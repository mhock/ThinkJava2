...
\newcommand{\theversion}{6.6.0e CS 142 Summer 2019 edition}
...
{\Large with a few changes by Martin Hock}
...
Additional modifications \copyright ~2018-2019 Martin Hock.
...
The original \LaTeX\ source for this book is available from \url{http://thinkjava.org/} and \url{https://github.com/ChrisMayfield/ThinkJava2}. Modifications have been made by Martin Hock.
...
\input{ch03.tex} % scanners, formatting, etc.
...
{\bf Martin Hock} made some stylistic changes and added a few examples; the bulk of the text is by the other authors.
